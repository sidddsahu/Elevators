...
/* =========================
   FILE: app/admin/services/components/ConfirmationModal.tsx
========================= */

type ConfirmColor = 'blue' | 'red' | 'green'
            ...
            <div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-red-100 mb-4">
              ...
              >
                <path
                  ...
                  strokeWidth={2}
                  d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.795-.833-2.565 0L4.343 16.5c-.77.833.192 2.5 1.732 2.5z"
                />
              </svg>
            </div>
